...
if(!Number.isSafeInteger(port)||port<1024||port>65535)throw Error('MINIAPP_UAT_PORT must be a local unprivileged port.');
...
await import('/vetrina-telegram/app.js?v=20260926-jewelry');
`;
...
http.createServer(async(req,res)=>{
 ...
 try{
   ...
   if(name==='index.html')content=content.replace('<script src="https://telegram.org/js/telegram-web-app.js"></script>','').replace('src="./app.js?v=20260926-jewelry"','src="/__qa/setup.js"');
...
}).listen(port,'127.0.0.1',()=>console.log('Local contract UAT: http://127.0.0.1:'+port+'/vetrina-telegram/'));
